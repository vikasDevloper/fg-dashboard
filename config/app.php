...
return [
	...
	|--------------------------------------------------------------------------
	|
	| Here you may configure all the settings for your application. Which will be
	| used on the site.
	|
	|
	 */

	'site_url'         => env('WEBSITE_URL', 'https://www.faridagupta.com'),
	'new_arrivals_url' => env('NEW_ARRIVALS_URL', 'https://www.faridagupta.com/new-arrivals.html'),
	'top_sellers_url'  => env('TOP_SELLERS_URL', 'https://www.faridagupta.com/top-sellers'),
	'fg_steal_url'     => env('FG_STEAL_URL', 'https://www.faridagupta.com/fg-steals.html'),
	'seperator'        => '/',
	'support_no'       => env('SUPPORT_NO', '8287567567'),
