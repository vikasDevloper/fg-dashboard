                           ...
                           <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" class="templateContainer" style="background-color: #f9f8f5;">
                              <tr>
                                 <td valign="top" class="bodyContainer">
                                                   ...
                                                   <tbody>
                                                      <tr>
                                                         <td class="mcnImageContent" valign="top" style="padding-top: 0px; padding-bottom: 0px; text-align:center;">
                                                            <a href="{{$fgStealUrl}}" target="_blank"><img align="center" alt="" src="https://www.faridagupta.com/media/wysiwyg/exhibitions-mail/fg-steals.png" class="exhbin" width="400" style="max-width:400px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage"></a>
                                                         </td>
                                                      </tr>
                                                   </tbody>
                                                </table>
                                    ...
                                    @php($i = 1)
                                    @foreach($topSellerSteals as $steals)
                                                ...
                                                <td valign="top" class="mcnImageBlockInner">
                                                   @if($i % 2 == 0)
                                                      <table align="left" width="50%" border="0" cellpadding="0" cellspacing="0" class="mcnImageGroupContentContainer">
                                                         <tbody>
                                                            <tr>
                                                               <td class="mcnImageContent" valign="top" style="padding-top: 10px; padding-bottom: 0px; text-align:center; height: 260px; vertical-align: middle;">
                                                                  <a href="{{$steals['productUrl']}}" target="_blank" style="font-size: 19px; text-decoration: none; color: #585858;">{{$steals['productName']}}</a>
                                                                  <br>
                                                                  <p style="font-size: 21px; color: #585858;"><del style="color: #999999;">&#8377;
 {{$steals['productPrice']}} /-</del>&nbsp;
&#8377;
{{$steals['productSpecialPrice']}} /-</p>
                                                                  <br>
                                                                  <a href="{{$steals['productUrl']}}" class="ctabutton" target="_blank">Buy Now</a>
                                                               </td>
                                                            </tr>
                                                         </tbody>
                                                      </table>
                                                         ...
                                                         <tbody>
                                                            <tr>
                                                               <td class="mcnImageGroupContent" valign="top" style="padding-top: 10px; padding-bottom: 10px; text-align:center;">
                                                                  <a href="{{$steals['productUrl']}}" target="_blank">
                                                                     <img alt="" src="{{$steals['productImageUrl']}}" width="180px" style="max-width:180px; padding-bottom: 0;" class="mcnImage">
                                                                  </a>
                                                               </td>
                                                            </tr>
                                                         </tbody>
                                             ...
                                             <td valign="top" class="mcnImageBlockInner">
                                                <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                                                   <tbody>
                                                      <tr>
                                                         <td class="mcnImageContent" valign="top" style="padding-top: 0; padding-bottom: 0; text-align:center;">
                                                            <a href="{{$fgStealUrl}}" class="ctabutton" target="_blank">View All</a>
                                                         </td>
                                                      </tr>
                                                      <tr>
                                                         <td class="mcnImageContent" valign="top" style="padding-top: 0; padding-bottom: 0; text-align:center;"><br>
                                                         </td>
                                                      </tr>
                                                   </tbody>
                                                </table>
