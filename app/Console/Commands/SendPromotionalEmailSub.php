...
class SendPromotionalEmailSub extends Command {
    /**
     * The name and signature of the console command.
     *
     * @var string
     */
    protected $signature = 'promotionalEmailSub:send {file}';
    ...
    public function handle() {
        ...
        $mailPurpose = 'email_'.$this->launchDate.'_nb';
        ...
        $this->subject       = "T1:14June-New Collection: Schiffli Embroidered Cotton Kurtas";
        $data['previewText'] = "Experience comfort beyond measure. COD Available.";
      ...
      $data['template'] = 'emails.promotions.14June_launch_mailer';
       ...
       //  $users[0]['purpose']     = 'email_'.$this->launchDate.'_nb_last90-30';
       ...
       //  $users[1]['purpose']     = 'email_'.$this->launchDate.'_nb_last90-30';
       ...
       //  $users[2]['purpose']     = 'email_'.$this->launchDate.'_nb_last180-90';
       ...
       //  $users[3]['purpose']     = 'email_'.$this->launchDate.'_nb_last180-90';
       ...
       //  $users[4]['purpose']     = 'email_'.$this->launchDate.'_nb_last320-180';
       ...
       //  $users[5]['purpose']     = 'email_'.$this->launchDate.'_nb_last320-180';
       ...
       //  $users[5]['city'] = '';
        ...
        // $users[6]['purpose']     = 'email_'.$this->launchDate.'_nb_last320-180';
        ...
        // $users[7]['purpose']     = 'email_'.$this->launchDate.'_nb_last640-320';
        ...
        // $users[9]['purpose']     = 'email_'.$this->launchDate.'_nb_last640-320';
       ...
       //  $users[10]['purpose']     = 'email_'.$this->launchDate.'_nb_last640-320';
       ...
       //  $users[11]['purpose']     = 'email_'.$this->launchDate.'_nb_last640-320';
       ...
       //  $users[12]['purpose']     = 'email_'.$this->launchDate.'_nb_last640-320';
       ...
       //  $users[14]['purpose']     = 'email_'.$this->launchDate.'_nb_last640-320';
       ...
       //  $users[11]['city'] = '';
        ...
        // $users[15]['purpose']     = 'email_'.$this->launchDate.'_nb_last640-320';
        // //$users[15]['city']        = 'XS,XL,XL,L,XS,XS,S,M,S,XL';
        // $users[15]['city']        = '';

        // $users[16]['email']       = 'sneha@faridagupta.com';
        // $users[16]['firstname']   = 'Sneha';
        // $users[16]['customer_id'] = '9999';
        // $users[16]['purpose']     = 'email_'.$this->launchDate.'_nb_last640-320';
        ...
        $users[13]['purpose']     = 'email_'.$this->launchDate.'_nb_last30';
        ...
        $users[8]['purpose']     = 'email_'.$this->launchDate.'_nb_last30';
        //$users[8]['purpose']     = 'email_'.$this->launchDate.'_b_2t';
            ...
            if (!empty($user['city'])) {
                ...
                switch ($user['purpose']) {
                    ...
                    case 'email_'.$this->launchDate.'_nb_ExDi':
                        ...
                        case 'email_'.$this->launchDate.'_nb_all':

                        $size_campaign = $this->launchDate.'_nb_all';
                            break;
