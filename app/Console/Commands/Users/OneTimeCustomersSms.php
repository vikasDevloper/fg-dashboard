...
class OneTimeCustomersSms extends Command {
	/**
	 * The name and signature of the console command.
	 *
	 * @var string
	 */
	protected $signature = 'oneTimeCustomersSms:create';
	 ...
	 * @var string
	 */
	protected $description = 'One Time Customers SMS (Exclude 30 days)';
	...
	public function createSms() {
		...
		$smsContentData['tag_sms'] = $smsContentData['utm_campaign'] = $utm_campaign = 'All-Time-1T';
		...
		switch ($lastSms) {
			...
			case "seasonal_collection":
				...
				$smsContentData['sms_content'] = $topSellingObj->createSMs();
				break;
			default:
				//for FgSteal Message1
				$smsContentData['sms_type']    = 'fg_steal';
				$fgStealObj                    = new PromoteFgSteal;
				$smsContentData['sms_content'] = $fgStealObj->createSms();
		}
