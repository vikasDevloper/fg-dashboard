...
class TwoTimeCustomers30daysSms extends Command {
	/**
	 * The name and signature of the console command.
	 *
	 * @var string
	 */
	protected $signature = 'twoTimeCustomers30daysSms:create';
	 ...
	 * @var string
	 */
	protected $description = 'Two Time Customers Sms (last 30 days)';
	...
	public function handle() {
		...
		$customers = SalesFlatOrder::twoTimeCustomers30daysSms();
	...
	public function createSms() {
		...
		$smsContentData['tag_sms'] = $smsContentData['utm_campaign'] = $utm_campaign = 'U30-D-2T';
		...
		foreach ($lastSendData as $lastSend) {
			...
			switch ($lastSms) {
				...
				case "top_seller":
					...
					$smsContentData['smsContent'] = 'seasonal collection sms content';
					break;
