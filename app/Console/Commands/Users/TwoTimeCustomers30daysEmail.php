...
class TwoTimeCustomers30daysEmail extends Command {
	/**
	 * The name and signature of the console command.
	 *
	 * @var string
	 */
	protected $signature = 'twoTimeCustomers30daysEmail:create';
	 ...
	 * @var string
	 */
	protected $description = 'Two Time Customers Email (last 30 days)';
	...
	public function handle() {
		...
		$customers = SalesFlatOrder::twoTimeCustomers30days();
	...
	public function createMail() {
		...
		$emailContentData['tag_email'] = $emailContentData['utm_campaign'] = $utm_campaign = 'U30-D-2T';
