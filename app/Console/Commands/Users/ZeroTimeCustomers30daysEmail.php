...
class ZeroTimeCustomers30daysEmail extends Command {
	/**
	 * The name and signature of the console command.
	 *
	 * @var string
	 */
	protected $signature = 'zeroTimeCustomers30daysEmail:create';
	 ...
	 * @var string
	 */
	protected $description = 'Zero Time Customers Email (last 30 days)';
	...
	public function createMail() {
		...
		$emailContentData['tag_email'] = $emailContentData['utm_campaign'] = $utm_campaign = 'U30-D-0T';
