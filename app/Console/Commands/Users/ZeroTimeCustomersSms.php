...
class ZeroTimeCustomersSms extends Command {
	/**
	 * The name and signature of the console command.
	 *
	 * @var string
	 */
	protected $signature = 'zeroTimeCustomersSms:create';
	 ...
	 * @var string
	 */
	protected $description = 'Zero Time Customers SMS (Exclude 30 days)';
	...
	public function handle() {
		...
		$NewsletterSubscribers = NewsletterSubscriber::getNewsletterSubscribers();
		$onlineCustomers = CustomerEntity::getAllOnlineCustomers();
