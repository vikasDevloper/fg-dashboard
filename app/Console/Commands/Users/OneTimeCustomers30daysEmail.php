...
class OneTimeCustomers30daysEmail extends Command {
	/**
	 * The name and signature of the console command.
	 *
	 * @var string
	 */
	protected $signature = 'oneTimeCustomers30daysEmail:create';
	 ...
	 * @var string
	 */
	protected $description = 'One Time Customers Email (last 30 days)';
			...
			if (!empty($emailContentData)) {
				...
				foreach ($customers as $customer) {
					...
					if (empty($customer['email'])) {
						...
						continue;
					} else if (in_array($customer['email'], $notifyMeUser)) {
						continue;
					}
	...
	public function createMail() {
		...
		$emailContentData['tag_email'] = $emailContentData['utm_campaign'] = $utm_campaign = 'U30-D-1T';
