...
class SendPromotionalEmails extends Command {
	...
	public function handle() {
        ...
        $this->subject       = "New Styles Added: Cotton Kurtas & Tops";
        $data['previewText'] = "15% OFF on Your First Order* | COD Available*";
		...
		//buyer
		$data['template'] = 'emails.promotions.24June_launch_mailer';
	    ...
	    //$users[13]['purpose']     = 'email_'.$this->launchDate.'_nb_last320-180';
		//$users[13]['purpose']     = 'email_'.$this->launchDate.'_b_all';
		...
		//$users[8]['purpose']     = 'email_'.$this->launchDate.'_b_delivrable';
	    $users[8]['purpose']     = 'email_'.$this->launchDate.'_b_cod';
	    //$users[8]['purpose']     = 'email_'.$this->launchDate.'_nb_last320-180';
	    $users[8]['city']        = 'XS,XL,XL,L,XS,XS,S,M,S,XL';
		//$users[8]['city'] = '';
		
		

		// $users[14]['email']       = 'shiv@faridagupta.com';
		// $users[14]['firstname']   = 'Shiv';
		// $users[14]['customer_id'] = '9999';
		// $users[14]['purpose']     = 'email_'.$this->launchDate.'_b_cod';
		// $users[14]['city']        = 'XS,XL,XL,L,XS,XS,S,M,S,XL';
		// //$users[11]['city'] = '';

		// $users[15]['email']       = 'vinay@faridagupta.com';
		// $users[15]['firstname']   = 'Vinay';
		// $users[15]['customer_id'] = '9999';
		// $users[15]['purpose']     = 'email_'.$this->launchDate.'_b_cod';
		// $users[15]['city']        = 'XS,XL,XL,L,XS,XS,S,M,S,XL';
		
       
  //       $users[16]['email']       = 'pranjali@faridagupta.com';
		// $users[16]['firstname']   = 'pranjali';
  ...
  //       $users[20]['email']       = 'ritu@faridagupta.com';
		// $users[20]['firstname']   = 'ritu';
		// $users[20]['customer_id'] = '9999';
		// $users[20]['purpose']     = 'email_'.$this->launchDate.'_1t';
		// $users[20]['city']        = 'XS,XL,XL,L,XS,XS,S,M,S,XL';

		// // //$users[11]['city'] = '';
 	// 	$users[19]['email']       = 'nitya@faridagupta.com';
		// $users[19]['firstname']   = 'nitya';
		// $users[19]['customer_id'] = '9999';
		// $users[19]['purpose']     = 'email_'.$this->launchDate.'_1t';
		// $users[19]['city']        = 'XS,XL,XL,L,XS,XS,S,M,S,XL';
			...
			if (!empty($user['city'])) {
				...
				switch ($user['purpose']) {
					...
					case 'email_'.$this->launchDate.'_b_1t':
						...
						break;
                    case 'email_'.$this->launchDate.'_b_prepaid':

						$size_campaign = $this->launchDate.'_b_prepaid_'.$sizein_campaign;
						break;
				...
				switch ($user['purpose']) {
					...
					case 'email_'.$this->launchDate.'_nb_all-last640':
						...
						$size_campaign = $this->launchDate.'_b_prepaid';
						break;
						case 'email_'.$this->launchDate.'_Global_cust':
