...
class EosstrigresEmail extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'eossTriggerEmail:send {file}';
     ...
     * @var string
     */
    protected $description = 'Email for trigger mail in EOSS';
    ...
    public function handle() {
        ...
        //Buyer
        $this->subject       = "End of Season Sale | Up to 30% off!";
        $data['previewText'] = "Your Exclusive Coupon Code Inside";
...
// \nRs 200\nOFF YOUR FIRST PURCHASE\n\nEnter Code XXXX at checkout\n\nRedeem Now!\n\nValid on cart value Rs 2,000-Rs 2,999. T&C Apply";
        ...
        //$data['template'] = 'emails.promotions.12thDec_EOSS2020_200Off_Subscriber';
        $data['template'] = 'emails.transactional.eoss_email_template';
    ...
    public function sendEmails($users, $data) {
        ...
        foreach ($users as $user) {
            ...
            if(preg_match('/^FG5/',  $user['coupon_code']))
            $data['template'] = 'emails.transactional.global_eoss_email_template';
            ...
            if (config('mail.through') == 'Falconide') {
                ...
                $data["from"]    = 'care@faridagupta.com';//config('mail.from.address');
